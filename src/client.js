...
socket.on('userPositions', _clientProps =>{
  ...
  for(let i = 0; i < Object.keys(_clientProps).length; i++){
    if(Object.keys(_clientProps)[i] != id){
      ...
      /*console.log("inloop:");
      console.log(clients[Object.keys(_clientProps)[i]]);
      var tmp_p = glScene.scene.getObjectByName(clients[Object.keys(_clientProps)[i]]);
      if(tmp_p != null){
      tmp_p.position.set(lerpedPos.x, lerpedPos.y, lerpedPos.z);
      }*/
    }
  }
});
