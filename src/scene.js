...
class Scene extends EventEmitter { // everything is inside an object
  ...
  user_movs () {
    if(this.w_key && !this.s_key){
        this.player_x = this.player_client.position.x + Math.cos((this.dir * 3.14159) / 180) * -0.15;
        this.player_z = this.player_client.position.z - Math.sin((this.dir * 3.14159) / 180) * -0.15;
        this.player_dir = 180;
    }
  ...
  cam_calculate(){
    this.camera.position.y = this.player_client.position.y + 2;
    this.camera.position.x = this.player_client.position.x + Math.cos((this.dir * 3.14159) / 180) * 4.0;
    this.camera.position.z = this.player_client.position.z - Math.sin((this.dir * 3.14159) / 180) * 4.0;
  }
  ...
  update(){
    ...
    this.commonvec2.set(this.player_client.position.x,this.player_client.position.y,this.player_client.position.z);
    this.cam_calculate();
